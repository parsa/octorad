...
cmake -H. -Bcmake-build-debug -G"Visual Studio 15 2017 Win64" -DOCTORAD_DUMP_DIR=C:/Users/Parsa/Desktop/arg-dumps -DOCTORAD_WITH_SCRATCHPAD=ON -DOCTORAD_DUMP_COUNT=OCTORAD_DUMP_COUNT=13140
